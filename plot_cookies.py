...
# SQL query
cookies_query = 'SELECT host, visit_id FROM javascript_cookies'
...
if __name__ == "__main__":
    ...
    vanilla_result = getQueryResult(VANILLA_DB_PATH, cookies_query)
    ...
    adblock_result = getQueryResult(ADBLOCK_DB_PATH, cookies_query)
    ...
    plt.title("Distribution of Third-Party Cookies Requests")
